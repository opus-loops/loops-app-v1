/**
 * Effect Schema decoders for telemetry runtime wire shapes.
 *
 * Env activation lives in {@link ./config}. This module keeps axios / abort /
 * span-attribute decoders used per request without throwing.
 */
import { Either, Option, Predicate, Schema } from "effect"
