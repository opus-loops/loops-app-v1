...
import { validateChoiceQuestion } from "@/modules/shared/api/explore/choice_question/validate-choice-question"
    ...
    if (exit._tag === "Success") {
      ...
      const failure = Option.getOrElse(Cause.failureOption(exit.cause), () => {
        ...
        return {
          ...
          message: "Unexpected error occurred while validating choice question",
        }
      })
